...
class ModelAccountOrder extends Model { 
	...
	public function getOrderForApp($order_id,$user_id){
		$order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND customer_id = '" . $user_id . "' AND order_status_id > '0'");
    ...
    public function getOrdersForApp($start = 0, $limit = 20,$id) {
        if ($start < 0) {
            $start = 0;
        }
        ...
        $query = $this->db->query("SELECT o.order_id, o.firstname, o.lastname, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `" . DB_PREFIX . "order` o LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . $id . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY o.order_id DESC LIMIT " . (int)$start . "," . (int)$limit);
    ...
    public function getTotalOrdersForApp($id){
        $query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` o WHERE customer_id = '" . $id . "' AND o.order_status_id > '0'");
