...
class XtensionsCheckout extends Controller {
	...
	public function unsetters(&$obj){		
		foreach (array('user_info','agree','customer','sameAddress','payment_address','payment','shipping','shipping_address','account','shipping_country_id','shipping_zone_id','shipping_postcode','payment_country_id','payment_zone_id','shipping_same_guest','captcha') as $key){
